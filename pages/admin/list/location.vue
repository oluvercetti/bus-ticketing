<template>
    <div class="mt-3">
        ...
        <b-table :items="computedLocationList" :fields="fields" :busy="isLoading" ref="location" class="mt-4" striped hover
            outlined>
        ...
        <b-modal v-model="showAddLocationModal" hide-footer title="Add Location">
            <b-form @submit.prevent="handleCreateNewLocation()">
                ...
                <b-button v-else type="submit" variant="primary" class="mr-3">Add Location</b-button>
        ...
        <b-modal v-model="showUpdateLocationModal" hide-footer title="Edit Location">
            <b-form @submit.prevent="updateLocation(selectedLocation)">
                ...
                <b-button v-else type="submit" variant="primary" class="mr-3">Save Location</b-button>
